/**
 ...
 Converts html select elements to a dropdown color picker.
*/
(function($ , undefined) {
	var ek_Colorpicker = function(element, option) {
		var options = $.extend({}, $.fn.ek_colorpicker.defaults, option);
		...
		dropdown.on('click', function(e) { //to show dropdown
			var a = $(e.target);
	...
	$.fn.ek_colorpicker = function(option, value) {
		var retval;

		var $set = this.each(function () {
			var $this = $(this);
			var data = $this.data('ek_colorpicker');
			var options = typeof option === 'object' && option;

			if (!data) $this.data('ek_colorpicker', (data = new ek_Colorpicker(this, options)));
