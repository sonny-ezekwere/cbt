...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="page-header title">
			<!-- PAGE TITLE ROW -->
			<h1>Shortlist <span class="sub-title">Award Scholarship</span></h1>
		</div>
	</div><!-- /.col-lg-12 -->
</div><!-- /.row -->
				...
				<div class="portlet">
					<div class="portlet-heading inverse">
						<div class="portlet-title">
							<h4><i class="fa fa-line-chart"></i> Award Scholarship to Applicant</h4>
						</div>
										...
										<div class="well white">
											<table id="ApplicantTbl" class="datatable table table-hover table-striped table-bordered tc-table">
												...
												<tbody>
													...
													<?php echo $ActionObj->getAllAppByStatus('0'); ?>
												</tbody>
											</table>
										</div>
									</form>
