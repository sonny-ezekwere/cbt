...
$sql = "SELECT * from privileges WHERE ID = '$id'";
		...
		$pri_name = $result->Fields('PRI_NAME')->Value;
	...
	<div class="col-lg-12">
		...
		<div class="breadcrumbs new">
			<ul class="breadcrumb">
				...
				<li class="active">Update Privileges</li>
			</ul>
			...
			<div id="f-6" class="panel-collapse collapse in">
				<div class="portlet-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="privilege" value="<?php echo $pri_name ; ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-actions">
							...
							onclick="showAjax('Page_Form','../includes/ajaxaction1.php?Action=updatePriv','processDiv')"
							>Update</button>
							<button type="submit" class="btn"
							onclick="showAjax('Page_Form','../includes/ajaxaction1.php?Action=cancelPriv','processDiv')"
							>Cancel</button>
						</div>
